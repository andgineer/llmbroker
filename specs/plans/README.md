...
|---|---|---|---|
| 1 | [`race.md`](race.md) | source-bound; execute next | explicit fastest-of routing plus default parallel protection when the pool first reuses a model after cooldown |
...
that question needs a controlled pair, which is queue row 3. A second mechanism aimed
