...
Такой вызов идёт параллельно с обычной моделью, чтобы за проверку платили не вы, а
ответом становится тот из двух, кто ответил первым. Больше ничего параллельным не
делается: пул из здоровых моделей по-прежнему отвечает на один вызов одним запросом.
